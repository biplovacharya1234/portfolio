    ...
    <div className="md:px-10 px-7 my-10" id="contact">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          <h1 className="text-yellow-400 font-semibold text-3xl mt-16">
            Connect with me:
          </h1>
        ...
        <div className="md:w-1/2">
          ...
          <form>
            ...
            <textarea
              ...
              placeholder="Message:"
            ></textarea>
            <button className="btn transition-all duration-500 bg-yellow-400 py-2 px-12 rounded text-white hover:bg-white hover:text-yellow-400 block">
              Send
            </button>
          </form>
        </div>
